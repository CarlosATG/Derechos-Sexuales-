...
music = pygame.mixer.music.load(directory +"/8bit.mp3")
pygame.mixer.music.play(-1)  # The -1 means the music will loop indefinitely
pygame.mixer.music.set_volume(.05)
JumpS= pygame.mixer.Sound(directory +"/assets/jump.mp3")
JumpS.set_volume(0.05)
JumpC = pygame.mixer.Sound(directory +'/assets/Correct!.mp3')
JumpC.set_volume(0.5)
SCREEN = pygame.display.set_mode((1280, 720))
pygame.display.set_caption("Menu")
#Fondos
medalla = pygame.image.load(directory +'/assets/Medallas1.png')
BG = pygame.image.load(directory +"/assets/Arcoiris.png")
GBG = pygame.image.load(directory +"/assets/gameBG.png")
Lab = pygame.image.load(directory +"/assets/Lab.png")
Siguiente = pygame.image.load(directory +"/assets/next.png").convert_alpha()
Back= pygame.image.load(directory +"/assets/back.png").convert_alpha()
BG_Mensajes= pygame.image.load(directory +"/assets/Messages.png").convert_alpha()
font =pygame.font.Font(directory +"/assets/Pixel_like.ttf",24)
timer=pygame.time.Clock()
snip = font.render('', True, 'black')
speed= 2
done= False
flecha = pygame.image.load(directory +'/assets/Pointer.png')
mute = pygame.image.load(directory +'/assets/muteBtn.png').convert()
mute_rect= mute.get_rect()
mute_rect.center=(25,20 )
#Animaciones
RosaIdle= pygame.image.load(directory +"/Rosa/Pink_Monster_Idle_4.png").convert_alpha()
RosaI = spritesheet.SpriteSheet(RosaIdle)
RosaWalkingR= pygame.image.load(directory +"/Rosa/Pink_Monster_Walk_6.png").convert_alpha()
...
RosaJumping= pygame.image.load(directory +"/Rosa/Pink_Monster_Jump_8.png").convert_alpha()
...
AzulIdle= pygame.image.load(directory +"/Azul/Dude_Monster_Idle_4.png").convert_alpha()
AzulI = spritesheet.SpriteSheet(AzulIdle)
AzulWalkingR= pygame.image.load(directory +"/Azul/Dude_Monster_Walk_6.png").convert_alpha()
...
AzulJumping= pygame.image.load(directory +"/Azul/Dude_Monster_Jump_8.png").convert_alpha()
...
def get_font(size): # Returns Press-Start-2P in the desired size
    return pygame.font.Font(directory +"/assets/04B_30__.TTF", size)


def Tutorial(color):
    TutorialBg = pygame.image.load(directory +'/assets/TutBG.png')
    if color == "Blue":
        Personaje = Azul_idle
...
def SegundoNivel(color):
    Dosopciones = pygame.image.load(directory +'/assets/C2.png')
    Tresopciones = pygame.image.load(directory +'/assets/C3.png')
    medalla = pygame.image.load(directory +'/assets/Medallas1.png')
    jumpvfx = True
    music_paused= False
    if color == "Blue":
...
def TercerNivel(colour):
    music_paused = False
    NeuroBG= pygame.image.load(directory +'/assets/Neuro.png')
    DosopcionesND = pygame.image.load(directory +'/assets/NeuroOpc.png')
    medalla = pygame.image.load(directory +'/assets/Medallas1.png')
    if colour == "Blue":
        Personaje = Azul_idle
        moveR = Azul_walking_right
    ...
    while True:
        ...
        if level == 2:
            ...
            if Correcto == 2:
                    ...
                    Correcto = 0
        if level == 3:
            medallados = pygame.image.load(directory +'/assets/Medallas2.png')
...
def CuartoNivel(colour):
    music_paused=False
    RainBG= pygame.image.load(directory +'/assets/Rainbow.png')
    DosopcionesRB = pygame.image.load(directory +'/assets/2RB.png')
    TresopcionesRB = pygame.image.load(directory +'/assets/3RB.png')
    medallados = pygame.image.load(directory +'/assets/Medallas2.png')
    jumpvfx = True
    if colour == "Blue":
        Personaje = Azul_idle
    ...
    while True:
        ...
        if level == 3:
            ...
            if Correcto == 2:
                    ...
                    Correcto = 0
        if level == 4:
            medallados = pygame.image.load(directory +'/assets/Medallas3.png')
            SCREEN.blit(medallados, (0,0))
...
def QuintoNivel(colour):
    music_paused=False
    LoveBG= pygame.image.load(directory +'/assets/LoveBG.png')
    TresopcionesLv = pygame.image.load(directory +'/assets/LvLootBox.png')
    medalla = pygame.image.load(directory +'/assets/Medallas3.png')
    jumpvfx = True
    if colour == "Blue":
        Personaje = Azul_idle
        moveR = Azul_walking_right
    ...
    while True:
        ...
        if level == 2:
            ...
            if Correcto == 2:
                    ...
                    Correcto = 0
        if level == 3:
            medallacuatro = pygame.image.load(directory +'/assets/Medallas4.png')
...
def SextoNivel(colour):
    music_paused = False
    LawBG= pygame.image.load(directory +'/assets/LawBG.png')
    TresopcionesLaw = pygame.image.load(directory +'/assets/LawLB.png')
    medalla = pygame.image.load(directory +'/assets/Medallas4.png')
    if colour == "Blue":
        Personaje = Azul_idle
        moveR = Azul_walking_right
        moveL = Azul_walking_Left
...
def options():
    QR=pygame.image.load(directory +'/assets/Resources.png')
    while True:
...
def main_menu():
    ...
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load(directory +"/assets/Play Rect.png"), pos=(640, 250),
                             text_input="JUGAR", font=get_font(75), base_color="#FFB2B2", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load(directory +"/assets/Options Rect.png"), pos=(640, 400),
                                text_input="INFO", font=get_font(75), base_color="#ffac2a", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load(directory +"/assets/Quit Rect.png"), pos=(640, 550),
